...
const UI_DICT: Record<string, Entry> = {
  ...
  thoughts: {
    en: "Thinking", ar: "تفكير", "ar-eg": "تفكير", es: "Razonamiento", fr: "Réflexion", de: "Denken", pt: "Raciocínio", it: "Ragionamento", tr: "Düşünme", ru: "Размышление", zh: "思考", ja: "思考", ko: "사고", hi: "सोच", id: "Pemikiran", nl: "Denken", sv: "Tänkande", cs: "Myšlení", ro: "Gândire", el: "Σκέψη", uk: "Роздуми", he: "חשיבה", fa: "تفکر", vi: "Suy nghĩ", th: "การคิด", pl: "Myślenie",
  },
  thinkingDeep: {
